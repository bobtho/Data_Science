...
Analysis of LSVT using Standard ML Classification Algorithms (Stratification)
...
# Creating a Parkinsons (LSVT) Dataframe
...
print(Xn_train.shape, Xn_test.shape)      # (100, 8) (26, 8)  
print(yn_train.shape, yn_test.shape)      # (100,) (26,)  
...
print(accuracy_score(yn_test,lr_pred_full))                    # 0.7857142857142857
print(recall_score(yn_test,lr_pred_full))                      # 0.7592592592592593


print(classification_report(yn_test,lr_pred_full))
print(confusion_matrix(yn_test,lr_pred_full))
 
##### SVM

SVM_pred_full = SVM.predict(Xn_test)

print(recall_score(yn_test,SVM_pred_full))                      # 0.037037037037037035
print(accuracy_score(yn_test,SVM_pred_full))                    # 0.6623376623376623

print(classification_report(yn_test,SVM_pred_full))
print(confusion_matrix(yn_test,SVM_pred_full))

##### RF

RF_predicted_full = RF.predict(Xn_test)
print(recall_score(yn_test,RF_predicted_full))                 # 0.6296296296296297
print(accuracy_score(yn_test,RF_predicted_full))               # 0.7307692307692307

print(classification_report(yn_test,RF_predicted_full))
print(confusion_matrix(yn_test,RF_predicted_full))

##### Decision Tree

DT_predicted_full =  DT.predict(Xn_test)
print(recall_score(yn_test,DT_predicted_full))                  # 0.6481481481481481
print(accuracy_score(yn_test,DT_predicted_full))                # 0.6558441558441559

print(classification_report(yn_test,DT_predicted_full))
print(confusion_matrix(yn_test,DT_predicted_full))
...
lr_full_pred = lr_up.predict(Xn_test)

# print(recall_score(y_test,y_pred_full, average = None)) 
print(recall_score(yn_test,lr_full_pred))                      # 0.7592592592592593
print(accuracy_score(yn_test,lr_full_pred))                    # 0.7922077922077922

print(classification_report(yn_test,lr_full_pred))
print(confusion_matrix(yn_test,lr_full_pred))
