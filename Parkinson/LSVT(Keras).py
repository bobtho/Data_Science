...
Analysis of Parkinson dataset using Keras 
...
Xn_train, Xn_test, yn_train, yn_test = train_test_split(Xn, yn, test_size = 0.20, random_state = 123, stratify=yn)

print(Xn_train.shape, Xn_test.shape)      # (100, 310) (26, 310)
...
print('Labels counts in yn_train:', np.bincount(yn_train))            #  [33 67]
print('Labels counts in yn_test:', np.bincount(yn_test))              #  [ 9 17]
...
rfe = rfe.fit(Xn_train, yn_train)

print(rfe.support_)
print(rfe.ranking_)

Lr_pred = rfe.predict(Xn_test) 
...
X_train, X_test = train_test_split(Parkinson_new, test_size = 0.20, random_state = 123)
...
# Create Test set on Acceptable Class (Class 0)
...
print(X_train.shape, X_test.shape)      # (67, 8) (26, 8)
...
print ("Trained model in {:.4f} seconds".format(end - start))      # Trained model in 0.3803 seconds
...
print ("Trained model in {:.4f} seconds".format(end - start))      # Trained model in 4.6164 seconds
...
LABELS = ["Non Acceptable", "Acceptable", ]                                  
